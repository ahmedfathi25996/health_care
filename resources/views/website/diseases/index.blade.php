...
<section class="content">
            ...
            <div class="box">
              ...
              <div class="box-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <td>
                      <a href="/doctor/diseases/{{$disease->id}}/edit" class="btn btn-primary"> Edit </a>
                      {!! Form::open(['action'=>['diseaseByDoctor@destroy',$disease->id],'method'=>'POST','class'=>'pull-right' ])  !!}
      ...
      <div class="box-footer clearfix">
              <a href="/doctor/diseases/create" class="btn btn-sm btn-info btn-flat center ">Add New Disease</a>
