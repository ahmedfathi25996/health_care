...
@section('content')
 ...
 <aside id="colorlib-hero">
        <div class="flexslider">
            ...
            <li style="background-image: url(website/images/img_bg_5.jpg);">
                <div class="overlay"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 col-md-pull-2 slider-text">
            ...
            <li style="background-image: url(website/images/img_bg_1.jpg);">
                <div class="overlay"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 col-md-pull-2 slider-text">
            ...
            <li style="background-image: url(website/images/img_bg_2.jpg);">
                <div class="overlay"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 col-md-pull-2 slider-text">
